...
export default function Home() {
  ...
  const handleAddMembers = async (config: {
    ...
    try {
      const response = await fetch('/api/add-members', {
        ...
        body: JSON.stringify({
          api_id: parseInt(config.apiId),
          api_hash: config.apiHash,
          phone: config.phone,
          group_id: config.groupId,
          members: csvData.map(m => m.username_or_phone),
          delay: config.delay,
        }),
      })
      ...
      setResults({
        success: false,
        message: 'Error adding members. Please check your configuration and try again.',
      })
    } finally {
      setIsLoading(false)
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-telegram-dark via-gray-900 to-black py-8 px-4">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <header className="text-center mb-12 mt-8">
          <div className="mb-4">
            <h1 className="text-5xl font-bold bg-gradient-to-r from-telegram-blue to-cyan-400 bg-clip-text text-transparent mb-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 backdrop-blur">
        ...
        {/* Help Section */}
        <section className="mt-16 bg-gray-800 border border-gray-700 rounded-lg p-8">
          <h2 className="text-2xl font-semibold text-white mb-6">
            How to Use
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-gray-300">
            <div>
              <h3 className="text-telegram-blue font-semibold mb-3">
              ...
              <p className="text-xs text-gray-400">
                Example:
                <br />
                <code className="bg-gray-900 px-2 py-1 rounded block mt-2">
